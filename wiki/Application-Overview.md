...
To require supporter keys later, set `ai_premium_only: true` in [release/app-config.json](https://github.com/Kava4/AimSync/blob/Beta/release/app-config.json) on GitHub (no rebuild needed).
