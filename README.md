...
> **Download:** [Latest release (AimSync.exe)](https://github.com/Kava4/AimSync/releases/latest) — no Python required on the AimSync PC.
...
1. Download **`AimSync.exe`** from [Releases](https://github.com/Kava4/AimSync/releases/latest)
