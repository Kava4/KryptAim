...
(function (global) {
    ...
    function showStoppedScreen(willShutdownPC) {
        ...
        const logoUrl = cfg().logoUrl || '/static/AimSync_mark.svg';
        document.body.innerHTML = `
            <div class="min-h-screen bg-neutral-950 flex items-center justify-center text-center p-6">
                <div class="flex flex-col items-center gap-4 max-w-sm">
                    <img src="${logoUrl}" alt="AimSync" class="h-36 md:h-44 w-auto max-w-[320px] object-contain mb-2 opacity-95" style="background: transparent;">
